  ...
  return (
    <div>
      ...
      <Section
        ...
        render={(p) => <RookieCard player={p} highlight={{ label: "Landing Spot", score: p.rookieProfile?.landingSpotScore ?? 0 }} />}
      />
      ...
      <Section
        ...
        render={(p) => <RookieCard player={p} highlight={{ label: "Opportunity", score: p.rookieProfile?.opportunityScore ?? 0 }} />}
      />
      ...
      <Section
        ...
        render={(p) => <RookieCard player={p} highlight={{ label: "Competition Risk", score: p.rookieProfile?.competitionScore ?? 0 }} />}
      />
      ...
      <Section
        ...
        render={(p) => <RookieCard player={p} highlight={{ label: "Breakout", score: p.rookieProfile?.breakoutScore ?? 0 }} />}
      />
